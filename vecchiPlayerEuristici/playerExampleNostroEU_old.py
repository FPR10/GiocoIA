...
_W_CAPTURE_OUTER   =  4   # P1: bonus catture verso l'esterno (nostro)
_W_CAPTURE_INNER   =  6   # P4: bonus per catturare pedine avversarie più interne
_W_MOVE_OUTER      =  3   # P2: bonus mosse non-catturanti verso l'esterno
_W_OUTER_PRESSURE  =  4   # P3: nostre pedine esterne vicino a zone con avversari esterni
_W_CORNER_SETUP    =  5   # P5: setup in due mosse verso angolo+cattura
