...
_W_CAPTURE_COUNT      = 4   # differenza numero catture disponibili

_W_POSITION           = 11     # vecchio val 9
_W_CAPTURE_OUTER      = 4     # P1: catture verso livelli esterni
_W_THREAT_PRESSURE    = 1     # P3: qualità delle catture disponibili
_W_CAPTURE_DANGEROUS  = 6     # vecchio val 6
_W_CORNER_SETUP       = 5     # P5: setup verso angoli/periferia

#Con  modifiche: _W_POSITION: 6→9  _W_CORNER_SETUP: 4→5  Nuovo miglior set (wr=0.650)
