...
#
#   Il vecchio codice usava delta di livello (dst - src) come criterio
#   per ordinare le mosse non catturanti. Questo causava un bug critico:
#   se l'avversario catturava e liberava una cella di livello 8, la nostra
#   pedina a livello 6 preferiva spostarsi su quella cella (delta = +2)
#   invece che verso l'angolo a livello 9 (delta = +3 ma solo se disponibile).
#   In realtà il problema era più sottile: tra due destinazioni con lo stesso
#   delta, l'euristica non distingueva il livello assoluto di arrivo.
#
#   Soluzione: la valutazione posizionale usa il livello ASSOLUTO di
#   destinazione pesato esponenzialmente. Livello 9 vale molto più di
#   livello 8, indipendentemente da dove la pedina si trovava prima.
#   L'ordinamento delle mosse ora usa prima il livello assoluto di destinazione
